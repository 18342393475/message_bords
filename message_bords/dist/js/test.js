...
window.onload = function () {
	...
	_reactDom2.default.render(_react2.default.createElement(
		_reactRedux.Provider,
		{ store: store },
		_react2.default.createElement(Nums, null)
...
var Num = function (_React$Component2) {
	_inherits(Num, _React$Component2);
	...
	function Num() {
		...
		return _possibleConstructorReturn(this, (_ref2 = Num.__proto__ || Object.getPrototypeOf(Num)).call.apply(_ref2, [this].concat(args)));
	}
...
function reducer() {
	var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { list: ["hello world"] };
	var action = arguments[1];
...
// Connected Component
var App = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Header);

var Nums = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Num);
