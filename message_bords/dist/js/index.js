...
/******/ 	var hotCurrentHash = "c0961e59fa804c260716"; // eslint-disable-line no-unused-vars
...
var content_data = [{ time: '2018-02-27 18:16:16', content: '你好吗，我是留言1' }, { time: '2018-02-28 18:16:16', content: '你好吗，我是留言2' }, { time: '2018-02-29 18:16:16', content: '你好吗，我是留言3' }].reverse();
...
window.onload = function () {
	...
	_reactDom2.default.render(_react2.default.createElement(
		_reactRedux.Provider,
		{ store: store },
		_react2.default.createElement(Footers, null)
	), document.getElementById('footer'));
};

function render() {
	var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { list: content_data };
	var action = arguments[1];
...
var Header = function (_React$Component) {
	...
	function Header() {
		...
		return _possibleConstructorReturn(this, (_ref = Header.__proto__ || Object.getPrototypeOf(Header)).call.apply(_ref, [this].concat(args)));
	}
	...
	_createClass(Header, [{
		...
		value: function render() {
			var _props = this.props,
			    content_data = _props.content_data,
			    onaddClick = _props.onaddClick;

			return _react2.default.createElement(
				"div",
				null,
				_react2.default.createElement("textarea", { ref: "textarea", placeholder: "\u8BF4\u70B9\u4EC0\u4E48\u5427......" }),
				_react2.default.createElement("input", { type: "button", value: "\u63D0\u4EA4", className: "fr", onClick: this.clickFn.bind(this), id: "btn" })
			);
		}
	}]);
...
var Content = function (_React$Component2) {
	...
	function Content() {
		...
		return _possibleConstructorReturn(this, (_ref2 = Content.__proto__ || Object.getPrototypeOf(Content)).call.apply(_ref2, [this].concat(args)));
	}

	_createClass(Content, [{
		key: "delClick",
		value: function delClick(e) {
			...
			list.map(function (v, i) {
				arr.push(_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							"span",
							{ "data-index": i, className: "del", onClick: _this3.delClick.bind(_this3) },
							"\u5220\u9664"
						),
						v.time
					)
...
var Footer = function (_React$Component3) {
	...
	function Footer() {
		...
		return _possibleConstructorReturn(this, (_ref3 = Footer.__proto__ || Object.getPrototypeOf(Footer)).call.apply(_ref3, [this].concat(args)));
	}
	...
	_createClass(Footer, [{
		...
		value: function render() {
			...
			return len ? _react2.default.createElement(
				"div",
				null,
				"\u5171",
				len,
...
var store = (0, _redux.createStore)(render);
...
function mapDispatchToProps(dispatch) {
	return {
		onaddClick: function onaddClick(time, text) {
			return dispatch({ type: 'add', time: time, text: text });
		},
		delClick: function delClick(index) {
			return dispatch({ type: 'del', index: index });
		}
	};
}

// Connected Component
var Headers = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Header);

var Contents = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Content);

var Footers = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Footer);
